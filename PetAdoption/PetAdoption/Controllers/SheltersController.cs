...
namespace PetAdoption.Controllers
{
    public class SheltersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShelterID,Name,email,phone")] Shelter shelter)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShelterID,Name,email,phone")] Shelter shelter)
        {
            if (ModelState.IsValid)
            {
