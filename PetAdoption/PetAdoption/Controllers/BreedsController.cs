...
namespace PetAdoption.Controllers
{
    public class BreedsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BreedID,BreedName,BreedType")] Breed breed)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BreedID,BreedName,BreedType")] Breed breed)
        {
            if (ModelState.IsValid)
            {
